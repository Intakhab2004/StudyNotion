...
const UpdatePassword = () => {
    ...
    const submitPasswordHandle = async (data) => {
        try{
            setLoading(true);
    ...
    return (
        <div>
            <form onSubmit={handleSubmit(submitPasswordHandle)}>
                    ...
                    <div className='flex flex-col lg:flex-row gap-5' >
                        <div className='relative flex flex-col gap-x-2 w-full' >
                            <label htmlFor="oldPassword" className='label-style tracking-wider mb-1' >Your Password <span className='text-pink-100'>*</span></label>
                                <input
                                    ...
                                    className='form-style !pr-12 placeholder:text-sm placeholder:tracking-wider'
                                ...
                                {
                                    errors.oldPassword && <p className="mt-1 text-[12px] text-yellow-100" >{errors.oldPassword?.message}</p>
                                }
                        </div>
                        ...
                        <div className='relative flex flex-col gap-x-2 w-full' >
                            <label htmlFor="newPassword" className='label-style tracking-wider mb-1' >New Password <span className='text-pink-100'>*</span></label>
                                ...
                                {
                                    errors.newPassword && <p className="mt-1 text-[12px] text-yellow-100" >{errors.newPassword?.message}</p>
                                }
                        </div>  
                    </div>
                </div>
