            ...
            <section className="bg-richblack-700">
                <div  className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
                    <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
                        ...
                        <p className="mx-auto mt-4 text-center text-base font-semibold text-richblack-300 lg:w-[95%]">
                    ...
                    <div className="absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
                        ...
                        <img src = {BannerImage2} alt = "img1" />
                        <img src = {BannerImage3} alt = "img1" />
                    </div>
                </div>
            </section>
                    ...
                    <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
                        <div className="my-24 flex lg:w-[50%] flex-col gap-10">
                            ...
                            <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                                ...
                                It all began with a group of educators, technologists, and lifelong learners who 
                                recognized the need for accessible, flexible, and high-quality learning opportunities 
                            ...
                            <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                                ...
                                platform that could bridge these gaps and empower individuals from all walks of 
                                life to unlock their full potential.
                            </p>
                        </div>

                        <div>
                            <img src = {FoundingStory} alt = "img4" className="shadow-[0_0_20px_0] shadow-[#FC6767]" />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
                        ...
                        <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                            ...
                            <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                                ...
                                vibrant community of learners, where individuals can connect, collaborate, 
